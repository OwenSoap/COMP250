...
public class TesterPosted {
	...
	public static void main(String[] args) throws Exception {
		...
		// The BigInteger class uses an 'add' method for addition, but
		// NaturalNumber
		// uses 'plus' instead, to avoid confusion with the LinkedList's 'add'
		// method
		...
		// The BigInteger class uses a 'subtract' method for addition, but
		// NaturalNumber
		// uses 'minus' instead. This name was chosen because it was a better
		// match
		// for 'plus'.
		...
		// The BigInteger class uses a 'multiply' method for addition.
		// NaturalNumber
		// uses 'times' instead.
		System.out.println();
